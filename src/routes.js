...
const Bed = React.lazy(() => import('./views/Building/Room/Bed/Bed'))
...
const EditBuilding = React.lazy(() => import('./views/Building/EditBuilding'))
...
const routes = [
  ...
  { path: '/editBuilding/:id', name: 'addUsers', element: EditBuilding },
